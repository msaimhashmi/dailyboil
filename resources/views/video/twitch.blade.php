        ...
        <div class="row">
            <div class="col-lg-4 col-md-12 col-sm-12">
                <div class="sidebarcard">
                    ...
                    <form method="get" action="/video/api" name="sbmt" autocomplete="off">
                        <div class="inputurl">
                            <input type="url" name="url" class="form-control" placeholder="https://" required="url">
                            <div class="dropdown">
                            <button type="button" class="btn btn-danger dropdown-toggle" data-toggle="dropdown">Download
                              ...
                              <div class="dropdown-menu dropdown-menu-left">
                                ...
                                <?php $fps = $json_array['resolutions'] ?>
                                @foreach($fps as $fs => $key)
                                <a class="dropdown-item" href="https://clips-media-assets2.twitch.tv/AT-cm%7C{{substr($json_array['_id'], 1)}}.mp4">{{$fs}}<img src="/assets/frontend/img/04.png">-mp4</a>
                                {{-- <a class="dropdown-item" href="/downloader?link={{substr($json_array['seek_previews_url'],0, -31)}}{{$fs}}/index-dvr&type=m3u8">{{$fs}}<img src="/assets/frontend/img/04.png">-mp4</a> --}}
                                @endforeach
                              </div>
                            </div>
