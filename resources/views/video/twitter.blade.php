...
<section><?php $links = $twdata['extended_entities']['media'][0]['video_info']['variants']; ?>
    <div class="container">
        <div class="row">
                    ...
                    <form class="example" method="get" action="/video/api" name="sbmt" autocomplete="off">
                        ...
                        <div class="dropdown">
                            <button type="button" class="btn btn-danger dropdown-toggle" data-toggle="dropdown">Download
                              ...
                              <div class="dropdown-menu dropdown-menu-left">
                                <p class="pl-3">Video</p>
                                    <a class="dropdown-item" href="{{$links[0]['url']}}"><img src="/assets/frontend/img/04.png"> MP4- 360p</a>
                              </div>
                            </div>
                            ...
                            <div class="videoimage text-center">
                                <span class="video-title">{{$twdata['full_text']}} -- Mp4 <br></span>
                                <span class="video-time">&nbsp;</span>
                            </div>
                            <div class="preview">
                                <img src="{{$twdata['entities']['media'][0]['media_url']}}" alt="">
                            </div>
                        </div>
                    </form>
                </div>
