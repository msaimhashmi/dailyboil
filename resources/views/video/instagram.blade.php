                    ...
                    <div class="inputurl">
                        <form class="example" method="get" action="/video/api" name="sbmt" autocomplete="off">
                             ...
                             <button type="button" class="btn btn-danger dropdown-toggle" data-toggle="dropdown">Download
                              ...
                              <div class="dropdown-menu dropdown-menu-left">
                                ...
                                <?php
                                    ...
                                    $videoname = $data['entry_data']['PostPage'][0]['graphql']['shortcode_media']['owner']['full_name'];
                                ?>
                                <a class="dropdown-item" target="__blank" href="{{$videourl}}" allowfullscreen><img src="/assets/frontend/img/04.png"> MP4 - 360P</a>
                              </div>
                            </div>
                            ...
                            <div class="videoimage text-center">
                                <span class="video-title">{{$videoname}} -- 
                                    <?php print_r($data['entry_data']['PostPage'][0]['graphql']['shortcode_media']['__typename']) ?><br></span>
                                <span class="video-time">08:12</span>
                            </div>
                            <div class="preview">
                                <img src="<?php print_r($data['entry_data']['PostPage'][0]['graphql']['shortcode_media']['display_url']) ?>" class="img-thumbnail">
                            </div>
                                    ...
                                    <div class="modal-content">
                                      <div class="modal-body mb-0 p-0">
                                        <div class="embed-responsive embed-responsive-16by9 z-depth-1-half">
                                          <iframe class="embed-responsive-item" src="<?php print_r($data['entry_data']['PostPage'][0]['graphql']['shortcode_media']['video_url']) ?>" allowfullscreen></iframe>
                                        </div>
                                      </div>
                                    </div>
                                  </div>
