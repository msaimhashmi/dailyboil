        ...
        <div class="row">
            <div class="col-lg-4 col-md-12 col-sm-12">
                <div class="sidebarcard">
                    ...
                    <?php 
                        $handlerdownloader = $handlerlink->getDownloader($url);
                        $handlerdownloader->setUrl($url);
                        if($handlerdownloader->hasVideo())
                        {
                            $detail = $handlerdownloader->getVideoDownloadLink();
                        }
                    ?>
                    <div class="inputurl">
                        <form class="example" method="get" action="/video/api" name="sbmt" autocomplete="off">
                            ...
                            <button type="button" class="btn btn-danger dropdown-toggle" data-toggle="dropdown">Download
                              ...
                              <div class="dropdown-menu dropdown-menu-left">
                                ...
                                <a class="dropdown-item" href="<?php echo $value['url']?>"><img src="/assets/frontend/img/04.png">Mp4 -- <?php print_r($value['quality'])?></a>
                                @endforeach
                            ...
                            <div class="videoimage text-center">
                                <span class="video-title"><?php echo $oembed->author_name ?> -- Mp4 <br></span>
                                <span class="video-time">Dauration -- <?php 
                                $minute = $oembed->duration/60%60;
                                $second = $oembed->duration%60; ?>
                                <?php echo $minute?>:<?php echo $second?>
                                </span>
                            </div>
                            <div class="preview">
                                <?php $t = html_entity_decode($oembed->html) ?>
                            <img src="<?php echo $oembed->thumbnail_url ?>" alt="">
                            <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#modalYT">Play Video</button>
                                ...
                                {{-- <iframe width="200" src="https://player.vimeo.com/video/{{substr($url, -9)}}" frameborder="0"></iframe> --}}
                            </div>
                            <!--<div class="row">-->
