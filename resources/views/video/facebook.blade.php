                    ...
                    <div class="inputurl">
                        <form class="example" method="get" action="/video/api" name="sbmt" autocomplete="off">
                            ...
                            <button type="button" class="btn btn-danger dropdown-toggle" data-toggle="dropdown">Download
                              ...
                              <div class="dropdown-menu dropdown-menu-left">
                                ...
                                <?php //-- Very simple variant
                                    ...
                                    if ($DEVICE !=true) 
                                {?>
                                @foreach($msg['links'] as $key => $link )
                                <a class="dropdown-item" href="/downloader?link={{urlencode($link)}}&title={{urlencode($msg['title'])}}&type=mp4"><img src="/assets/frontend/img/04.png"> {{$key}} </a>
                                @endforeach
                                <?php }else{ ?>
                                @foreach($msg['links'] as $key => $link )
                                <a class="dropdown-item" href="{{$link}}" allowfullscreen><img src="/assets/frontend/img/04.png">{{$key}}</a>
                                @endforeach
                                <?php } ?>
                              </div>
                            </div>
                            ...
                            <div class="videoimage text-center">
                                <span class="video-title">{{$msg['title']}} -- Mp4 <br></span>
